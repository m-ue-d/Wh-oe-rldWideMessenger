    ...
    init {
        ...
        this.children.addAll(
            HBox(
                ...
                ImageView(
                    Image("spg/client/images/settings/connected.png")
                ).apply {
                    this.fitWidth = 25.0
                    this.fitHeight = 25.0
                },
                ...
                VBox(
                    ImageView(
                        Image("spg/client/images/settings/client.png")
                    ).apply {
                        this.fitWidth = 50.0
                        this.fitHeight = 50.0
                    },
                ...
                ImageView(
                    Image("spg/client/images/settings/disconnected.png")
                ).apply {
                    this.fitWidth = 25.0
                    this.fitHeight = 25.0
                },
                ...
                VBox(
                    ImageView(
                        Image("spg/client/images/settings/no-connection.png")
                    ).apply {
                        this.fitWidth = 50.0
                        this.fitHeight = 50.0
                    },
