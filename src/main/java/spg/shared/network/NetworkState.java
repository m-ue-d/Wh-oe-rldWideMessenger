...
public enum NetworkState {
    ...
    public static class PacketHandlerInitializer {
         ...
         */
        public <PL extends PacketListener> NetworkState.PacketHandlerInitializer setup(NetworkSide side, PacketHandler<PL> handler) {
     ...
     * For example, the Login, Signup and Account Reset packets are all handled by the same handler, the {@link spg.server.network.ServerAuthHandler}.
     *
